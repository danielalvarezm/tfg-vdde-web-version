        ...
        <div v-if="showChart === true">
          ...
          <div>
            <ion-text class="bigger-text">
             En esta página podrá apreciar el índice o tasa de natalidad en España, en las distintas comunidades autónomas según el año.
            </ion-text>
            <div>
              <ul>
                <li>
                ...
                <li class="do-margin-top">
                  <ion-text class="bigger-text">
                    <a href="https://datos.gob.es/es/catalogo/ea0010587-tasa-de-natalidad-por-comunidad-autonoma-segun-nacionalidad-espanola-extranjera-de-la-madre-idb-identificador-api-49429" target="_blank">Enlace al sitio</a>
                  </ion-text>
                </li>
                <li class="do-margin-top">
                  <ion-text class="bigger-text">
                    <a href="https://api.vdde.me/natalidad" target="_blank">Accede al dataset</a>
                  </ion-text>
                </li>
              </ul>
            </div>
